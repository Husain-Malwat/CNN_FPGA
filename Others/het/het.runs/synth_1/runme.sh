...
HD_PWD='C:/Users/husain/Documents/GitHub/CIFAR10_CNN/het/het.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_method1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_method1.tcl
